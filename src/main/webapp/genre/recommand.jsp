  ...
  <h2>추천영화 : 
  	<form action="recommand.do" method="post">
		<select name="redata">
			...
			<option value="비오는 날">비오는 날</option>
			<option value="눈오는 날">눈오는 날</option>
			<option value="더운 날">더운 날</option>
			<option value="추운 날">추운 날</option>
			<!-- value없으면 option사이값이 보내진다. 같으면 value안써도 된다. -->
		</select> 
